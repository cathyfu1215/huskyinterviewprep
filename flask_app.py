        ...
        <main class="container px-4 py-8">
            ...
            <section class="bg-white rounded-xl shadow-md p-6 mb-8">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <textarea x-model="jobDesc" class="w-full h-40 px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="Paste the job description here..."></textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Company Information</label>
                        <textarea x-model="companyInfo" class="w-full h-20 px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="Enter information about the company..."></textarea>
                        
                        <label class="block text-sm font-medium text-gray-700 mt-4 mb-2">Your Resume</label>
                        <textarea x-model="resume" class="w-full h-40 px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" placeholder="Paste your resume or relevant experience here..."></textarea>
                    </div>
                </div>
                <div class="mt-6 flex flex-wrap gap-4">
                    <button @click="analyzeInfo()" class="btn-primary px-6 py-3 rounded-lg font-medium flex items-center">
                        <i class="fas fa-search mr-2"></i> Analyze Information
                    </button>
                    <button @click="generateQuestions()" class="btn-primary px-6 py-3 rounded-lg font-medium flex items-center">
                        <i class="fas fa-list-ul mr-2"></i> Generate Interview Questions
                    </button>
                </div>
                ...
                <template x-if="parsedInfo.company_values">
                    <div class="mt-8 grid md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p class="text-gray-700" x-text="parsedInfo.company_values"></p>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h3 class="font-semibold text-gray-800 mb-2">Job Duties</h3>
                            <p class="text-gray-700" x-text="parsedInfo.job_duties"></p>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h3 class="font-semibold text-gray-800 mb-2">Tech Skills</h3>
                            <p class="text-gray-700" x-text="parsedInfo.tech_skills"></p>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h3 class="font-semibold text-gray-800 mb-2">Soft Skills</h3>
                            <p class="text-gray-700" x-text="parsedInfo.soft_skills"></p>
                        </div>
                    </div>
                </template>
            </section>
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    ...
                    <div class="md:col-span-1">
                        <div class="text-center">
                            ...
                            <button @click="readQuestionAloud()" class="btn-secondary w-full px-4 py-2 rounded-lg font-medium flex items-center justify-center">
                                <i class="fas fa-volume-up mr-2"></i> Read Question Aloud
                            </button>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="mt-4">
                            <button @click="analyzeAnswer()" class="btn-primary px-6 py-3 rounded-lg font-medium flex items-center">
                                <i class="fas fa-chart-line mr-2"></i> Analyze Answer
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <section x-show="feedbackText" class="bg-white rounded-xl shadow-md p-6 mb-8">
                ...
                <div class="bg-gray-50 p-6 rounded-lg">
                    ...
                    <div class="prose text-gray-700" x-html="feedbackText"></div>
                </div>
            </section>
            ...
            <section x-show="feedbackText" class="bg-white rounded-xl shadow-md p-6 mb-8">
                ...
                <button @click="generateModelAnswer()" class="btn-primary px-6 py-3 rounded-lg font-medium flex items-center mb-6">
                    <i class="fas fa-magic mr-2"></i> Generate Model Answer
                </button>
                
                <template x-if="modelAnswer">
                    <div class="bg-gray-50 p-6 rounded-lg">
                        <h3 class="font-semibold text-gray-800 mb-3">Sample Professional Answer</h3>
                        <div class="prose text-gray-700" x-html="modelAnswer"></div>
                    </div>
                </template>
            </section>
            ...
            <section x-show="feedbackText && modelAnswer" class="bg-white rounded-xl shadow-md p-6 mb-8">
                ...
                <button @click="saveToHTML()" class="btn-primary px-6 py-3 rounded-lg font-medium flex items-center">
                    <i class="fas fa-download mr-2"></i> Save as HTML
                </button>
